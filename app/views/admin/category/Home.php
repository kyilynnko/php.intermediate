                ...
                <!-- login form stat -->
                    ...
                    <form  action="<?php echo URLROOT . 'category/create' ?>" method='post' class="table-bordered p-5">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control english rounded-0 <?php echo !empty($data['name_err']) ? 'is-invalid' : ''; ?>" id="name" name="name"  placeholder="Category Name">
                        ...
                        <div class="row justify-content-end no-gutters">
                            <div>
                                ...
                                <button class="btn btn-primary english" id="create" name="create">Create</button>
                            </div>
                        </div>
                    </form>
                <!-- login form end -->
